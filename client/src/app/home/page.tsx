...
export default function Home() {
  return (
    <div className="bg-[#f7f7f3] ">
      <Header />
      {/* Hero Section */}
      <div className=" relative min-h-screen flex justify-around 2xl:items-center flex-wrap md:flex-nowrap">
        <div className=" md:order-last flex flex-col justify-center ">
          <Image
            ...
            height={400}
            alt="hero"
            className="lg:w-[500px] sm:w-[450px] md:w-[400px] 2xl:w-[850px] bg-[rgb(247,247,243)]"
          />
        </div>
        <div className="flex flex-col flex-wrap   gap-10 xl:gap-14 mt-10 xl:mt-20 md:mt-0">
          <div className="space-y-6 2xl:space-y-12">
            <h1 className="text-5xl font-bold 2xl:text-6xl leading-[3.4rem] font-sansSerif text-[#4a4a4a]">
              Learn new
              <br />
              concepts for
              <br /> each question
      ...
      <div className=" mt-10 2xl:mt-14" id="benefits">
        <div className="font-rubik text-center text-xl 2xl:text-3xl  text-[#4a4a4a] uppercase">
          <p>Benefits</p>
        </div>
        <div className="font-sansSerif text-center text-5xl 2xl:text-7xl mt-5 font-medium text-[#4a4a4a] ">
          <h1>
        ...
        <div className="mt-8">
          <p className="font-rubik text-center text-lg 2xl:text-2xl text-[#4a4a4a] md:w-full ">
          ...
          <div className="w-full md:flex  md:justify-center md:items-center  gap-24 ">
            <div>
              <Image
                ...
                height={400}
                alt="hero"
                className="lg:w-[500px] sm:w-[450px]  2xl:w-[850px] mx-auto bg-[rgb(247,247,243)] flex justify-center"
              />
            </div>
            ...
            <div className="grid grid-cols-[auto,1fr] gap-x-6 items-start md:w-1/3 lg:w-1/2">
              ...
              <div className="h-full grid grid-cols-1 grid-rows-[max(44px),1fr]">
                <div className="h-[44px] w-[44px] 2xl:w-[60px] 2xl:h-[60px] rounded-full border-2 border-dotted border-[#FFC727] flex justify-center items-center">
                  <AiOutlineBulb className="h-6 w-6 2xl:h-10 2xl:w-10 text-[#FFC727]  stroke-[50]" />
                </div>
              ...
              <div className="mb-12 last:mb-0 mt-1">
                <h2 className="mb-4 font-sansSerif text-3xl 2xl:text-5xl font-semibold text-[#4a4a4a]">
                  Elevate Your Exam Preparation
                </h2>
                <p className="text-large font-rubik 2xl:text-2xl text-[#4a4a4a]">
              ...
              <div className="h-full grid grid-cols-1 grid-rows-[max(44px),1fr]">
                <div className="h-[44px] w-[44px] 2xl:w-[60px] 2xl:h-[60px] rounded-full border-2 border-dotted border-[#FFC727] flex justify-center items-center">
                  <AiOutlineSun className="h-6 w-6  2xl:h-10 2xl:w-10 text-[#FFC727]  stroke-[50] " />
                </div>
                <div className="h-full flex justify-center">
                  <div className="w-1 h-full border-l-2 border-dotted border-[#FFC727]"></div>
                </div>
              ...
              {/* Benefit 3 */}
              <div className="h-full grid grid-cols-1 grid-rows-[max(44px),1fr]">
                <div className="h-[44px] w-[44px] 2xl:w-[60px] 2xl:h-[60px] rounded-full border-2 border-dotted border-[#FFC727] font-bold flex justify-center items-center">
                  <AiOutlineThunderbolt className="h-6 w-6  2xl:h-10 2xl:w-10 text-[#FFC727] stroke-[50] " />
                </div>
                <div className="h-full flex justify-center">
                  <div className="w-1 h-full border-l-2 border-dotted border-[#FFC727]"></div>
                </div>
      ...
      <div className="mt-10 2xl:mt-32" id="feature">
        <div className="font-rubik text-center text-xl 2xl:text-3xl  text-[#4a4a4a] uppercase">
          <p>Unlock Your Potential</p>
        </div>
        <div className="font-sansSerif text-center text-5xl 2xl:text-7xl mt-5 w-[70%] mx-auto font-medium text-[#4a4a4a] ">
          <h1>Elevate Your Exam Preparation with QuizyGrad Features</h1>
        </div>
        <div className="mt-8">
          <p className="font-rubik text-center text-lg 2xl:text-xl text-[#4a4a4a] w-[75%] mx-auto ">
        ...
        <div className="lg:flex lg:flex-wrap space-y-4 lg:space-y-0 justify-evenly  mt-28">
          <div className=" lg:w-1/4 flex flex-col text-center gap-y-5">
            <div>
              <AiFillProduct className="text-5xl 2xl:text-7xl mx-auto p-3 stroke-[30] bg-[#eceddd] text-[#FFC727] rounded-full" />
            </div>
            <div className="text-3xl 2xl:text-4xl font-semibold text-[#4a4a4a] font-sansSerif">
              <h1>Create an Exam Plan</h1>
            </div>
            <div className="mt-4">
              <p className="text-center text-large 2xl:text-xl font-rubik text-[#4a4a4a]">
          ...
          <div className="lg:w-1/4 flex flex-col text-center gap-y-5">
            <div>
              <AiOutlineAlert className="text-5xl 2xl:text-7xl mx-auto p-3 stroke-[30] bg-[#eceddd] text-[#FFC727] rounded-full" />
            </div>
            <div className="text-3xl 2xl:text-4xl font-semibold text-[#4a4a4a] font-sansSerif">
          ...
          <div className=" lg:w-1/4 flex flex-col  gap-y-5">
            <div>
              <AiOutlineApi className="text-5xl 2xl:text-7xl p-3 mx-auto stroke-[30] bg-[#eceddd] text-[#FFC727] rounded-full" />
            </div>
            <div className="text-3xl 2xl:text-4xl font-semibold text-center text-[#4a4a4a] font-sansSerif">
      ...
      <div className="mt-20 bg-[#fce6b5] rounded-xl p-14 w-[90%] mx-auto">
        <div className="text-center  space-y-6">
          <div>
            <h1 className="text-3xl 2xl:text-4xl  font-semibold text-[#4a4a4a] font-sansSerif">
              Unlock Your Exam Potential with QuizGrad Today
            </h1>
          </div>
          <div>
            <p className="text-lg 2xl:text-xl font-rubik text-[#4a4a4a]">
